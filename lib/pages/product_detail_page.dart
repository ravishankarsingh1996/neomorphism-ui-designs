        ...
        children: <Widget>[
          ClipRRect(
            ...
            child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  Image.network(widget.product.posterImageUrl, height: screenSize.height* 0.5, width: double.infinity,
                  fit: BoxFit.cover,),
                  Positioned(
                    top: 0,
                    left: 0,
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  SizedBox(height: 30,),
                  RoundEdgeCollectionCard(product: widget.product, isDetail: true,),
                  Container(
                    height: 260,
                    width: double.infinity,
